              ...
              ( \material ->
                  pure $
                    Primitive
                      { attributes =
                          M.fromList
                            [ (Position, fromV3List [V3 0.1 0.1 0.1]),
        ...
        makePrimitive g m
          `shouldBe` Just
            ( Primitive
                { attributes =
                    M.fromList
                      [ (Position, fromV3List [V3 0.1 0.1 0.1, V3 0.2 0.2 0.2, V3 0.3 0.3 0.3]),
                        (TexCoord 0, fromV2List [V2 0.11 0.11, V2 0.21 0.21, V2 0.31 0.31]),
                        (Normal, fromV3List [V3 0.12 0.12 0.12, V3 0.22 0.22 0.22, V3 0.32 0.32 0.32])
                      ],
